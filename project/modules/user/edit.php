<?php
/**
 * project/modules/user/edit.php - Modul Edit Data Barang (CRUD - Update)
 */
...
// 2. Proses Form Submit (Update Data)
if (isset($_POST['submit'])) {
    ...
    $gambar_lama = $data['gambar']; // Ambil nama gambar lama

    $gambar = $gambar_lama; // Default: pertahankan gambar lama

    // Handle File Upload Baru (Jika ada file baru diupload)
    ...
    // sssiiis : string, string, string, integer, integer, integer, integer
    ...
    if ($stmt_update->execute()) {
        ...
        // Ambil ulang data terbaru untuk mengisi form (Penting agar tampilan form terupdate)
...
// Data yang akan ditampilkan di form
...
<div class="login-box" style="max-width: 450px;">
    <form method="post" action="index.php?page=user/edit&id=<?php echo $id_barang; ?>" enctype="multipart/form-data">
        ...
        <div class="input">
            ...
            <?php if ($data['gambar']): 
                // Menggunakan class CSS 'edit-img-thumbnail' agar ukurannya kecil
